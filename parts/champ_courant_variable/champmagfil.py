...
titre_gauss = "Réponse à un paquet gaussien d'extension " +         r"$\tau={:.2e}$".format(5e-11) + " $\mathrm{s}$"
...
temps = (0,4e-8)
titre = "Propagation d'un paquet gaussien d'extension " +             r"$\tau = {:.2e}$".format(5e-11) +             "$\mathrm{s}$"
